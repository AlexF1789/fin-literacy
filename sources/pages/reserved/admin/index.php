...
<html lang="en-US">
    <head>
        <!-- TITLE AND METAS -->
        <title>Financial Literacy - admin area</title>
        <meta charset="UTF-8"/>
    ...
    <body>
        ...
        <section>
            <article>
                <h1 style="display: inline-block">Hi, Admin</h1>&emsp;<a class="link" title="Logoff from the website" onclick="logout()">logout</a>
                
                <br><br><button onclick="registerWriter()">Register writer</button><br><br>
                <a href="/sources/pages/reserved/admin/users.php"><button>Users</button></a><br><br>
                <button class="redButton" onclick="deleteUser()">Delete user</button><br><br>
            </article>
        </section>
