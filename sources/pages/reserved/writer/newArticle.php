...
<html lang="en-US">
    <head>
        <!-- TITLE AND METAS -->
        <title>Financial Literacy - new article</title>
        <meta charset="UTF-8"/>
    ...
    <body>
        ...
        <section>
            <article>
                <h1>New Article</h1>
                <p>Insert the title and the text of the article (which can be formatted by pressing the icons in the textbox) to pubblish the article; if you desire to add images you can add them in a second time by pressing the <i>add images</i> link in the <i>Your articles</i> section.<br><br><b>IMPORTANT ADVICE</b>&emsp;frequently have a backup of the article so as to avoid the risk of losing it.</p><br>
                
                <form method="POST" action="/sources/pages/auto/insertArticle.php">

                    <input type="text" class="textField" name="title" placeholder="Article title" style="width: 60%" required>
                    <br><br><p>Article content</p>
                    <textarea style="width: 100%; height: 25vW;" name="text"></textarea>

                    <br><br>
                    <center>
                        <input type="submit" value="Pubblish article" class="button">
                    </center>
                </form>
