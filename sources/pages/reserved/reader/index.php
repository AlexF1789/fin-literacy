...
<html lang="en-US">
    ...
    <body>
        ...
        <section>
            <article>
                <h1 style="display: inline-block">Hi, <?php echo $_SESSION['name'] ?></h1>&emsp;<img class="flag" src="/sources/images/flags/<?php echo $_SESSION['nationality'] ?>.png" alt="<?php echo $_SESSION['nationality'] ?>" type="image/png">&emsp;<a class="link" title="Logoff from the website" onclick="logout()">logout</a>
                
                <br><br><a href="/sources/pages/reserved/data.php"><button>Your data</button></a><br><br>
