<?php
    ...
    // FAKE PHP PAGE -> used to correctly implement Google Translate (see main.js)
...
<html lang="en-US">
    <head>
        <!-- TITLE AND METAS -->
        <title>Financial Literacy - Error 403</title>
        <meta charset="UTF-8"/>
    ...
    <body>
        ...
        <section>
            <article>
                <h1>Error 403</h1>
                <p>Unfortunately, while browsing the website you encourred in a 403 error (the page you were looking for can't be visited).<br>Don't worry, you can press the <i>back</i> arrow in your web browser to go back or press one of the links in the right/bottom part of the page to quick navigate.</p><br><p>If the problem persists contact us by pressing the button <i>Help</i>.</p>
        ...
        <footer>
            ...
            <label>Last edit on 2023 November 1<sup>st</sup></label>
            <hr>
